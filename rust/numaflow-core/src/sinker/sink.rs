...
mod kafka;
/// MonoVertex Kafka EOS sink (Phase 4)
#[path = "sink/kafka_eos.rs"]
pub(crate) mod kafka_eos;
/// MonoVertex S3 EOS sink (Phase 4)
#[path = "sink/s3_eos.rs"]
pub(crate) mod s3_eos;
/// MonoVertex JetStream EOS sink (Phase 4)
#[path = "sink/jetstream_eos.rs"]
pub(crate) mod jetstream_eos;
mod pulsar;
mod sqs;
